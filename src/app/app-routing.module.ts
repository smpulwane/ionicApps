...
const routes: Routes = [
  ...
  { path: 'edit-item/:_quantity/:_itemId', loadChildren: './tab1/cart/edit-item/edit-item.module#EditItemPageModule' },
  ...
  { path: 'conf', loadChildren: './conf/conf.module#ConfPageModule' }
];
@NgModule({
  imports: [
